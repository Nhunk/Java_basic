...
public class R3_RMIS_Chat1 extends UnicastRemoteObject implements R3_RMI_interface {
    private String message = "";

    protected R3_RMIS_Chat1() throws RemoteException {
        super();
    }
    ...
    public static void main(String[] args) {
        try {
            R3_RMIS_Chat1 server = new R3_RMIS_Chat1();
